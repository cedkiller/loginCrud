...
import {setTask, getRecordSlice, addTaskSlice, deleteTaskSlice, logoutSlice} from '../store/slice/crudSlice';
            ...
            <div className='div'>
                ...
                <form onSubmit={addTask}>
                    <div style={{display:'flex'}}>
                        <input type="text" placeholder='Enter a task' onChange={(e) => dispatch(setTask(e.target.value))} className='form-control'/>
